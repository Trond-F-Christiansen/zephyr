...
/* Conditional compilation for device-specific code, needed if channels should be included on a subset of applications devices */
...
ZBUS_MULTIDOMAIN_CHAN_DEFINE(response_channel, struct response_data, NULL, NULL, ZBUS_OBSERVERS_EMPTY,
		 ZBUS_MSG_INIT(0), IS_ENABLED(ZBUS_DEVICE_B), include_on_device_a_b);
