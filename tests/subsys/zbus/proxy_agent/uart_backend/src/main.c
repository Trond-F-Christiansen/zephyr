...
FAKE_VALUE_FUNC3(int, fake_proxy_agent_backend_recv_cb, uint8_t *, size_t, void *);
FAKE_VALUE_FUNC3(int, fake_proxy_agent_backend_recv_cb_error, uint8_t *, size_t, void *);
...
ZTEST(uart_backend, test_recv_too_large)
{
	...
	uint32_t huge_length = 0xFFFFFFFF;
