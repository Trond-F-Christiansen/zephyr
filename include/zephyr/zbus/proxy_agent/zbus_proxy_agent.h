 ...
 */
#define ZBUS_PROXY_ADD_CHANNEL(_proxy_node, _chan)                                                 \
	_ZBUS_PROXY_ADD_CHANNEL_WRAPPER(_proxy_node, _chan)

/** @cond INTERNAL_HIDDEN */
/* Wrapper layer for macro expansion */
#define _ZBUS_PROXY_ADD_CHANNEL_WRAPPER(_proxy_node, _chan)                                        \
	_ZBUS_PROXY_ADD_CHANNEL_IMPL(zbus_##_proxy_node, _chan)

/* Implementation layer performs the actual channel registration */
#define _ZBUS_PROXY_ADD_CHANNEL_IMPL(_proxy_name, _chan)                                           \
 ...
 */
#define ZBUS_SHADOW_CHANNEL_DEFINE(_name, _type, _proxy_node, _user_data, _observers, _init_val)   \
	_ZBUS_SHADOW_CHANNEL_DEFINE_WRAPPER(_name, _type, _proxy_node, _user_data, _observers,     \
					    _init_val)

/** @cond INTERNAL_HIDDEN */

/* Wrapper layer expands parameters before passing to implementation layer */
#define _ZBUS_SHADOW_CHANNEL_DEFINE_WRAPPER(_name, _type, _proxy_node, _user_data, _observers,     \
					    _init_val)                                             \
	_ZBUS_SHADOW_CHANNEL_DEFINE_IMPL(_name, _type, zbus_##_proxy_node, _user_data, _observers, \
					 _init_val)

/* Implementation layer performs the actual shadow channel definition */
#define _ZBUS_SHADOW_CHANNEL_DEFINE_IMPL(_name, _type, _proxy, _user_data, _observers, _init_val)  \
 ...
 * @param _init_val Initial channel value
 */
#define ZBUS_SHADOW_CHANNEL_DEFINE_WITH_ID(_name, _id, _type, _proxy_node, _user_data, _observers, \
					   _init_val)                                              \
	_ZBUS_SHADOW_CHANNEL_DEFINE_WITH_ID_WRAPPER(_name, _id, _type, _proxy_node, _user_data,    \
						    _observers, _init_val)

/** @cond INTERNAL_HIDDEN */

/* Wrapper layer expands parameters before passing to implementation layer */
#define _ZBUS_SHADOW_CHANNEL_DEFINE_WITH_ID_WRAPPER(_name, _id, _type, _proxy_node, _user_data,    \
						    _observers, _init_val)                         \
	_ZBUS_SHADOW_CHANNEL_DEFINE_WITH_ID_IMPL(_name, _id, _type, zbus_##_proxy_node,            \
						 _user_data, _observers, _init_val)

/* Implementation layer performs the actual shadow channel definition */
#define _ZBUS_SHADOW_CHANNEL_DEFINE_WITH_ID_IMPL(_name, _id, _type, _proxy, _user_data,            \
						 _observers, _init_val)                            \
/* Forward declare the proxy's shadow validator function (generated by ZBUS_PROXY_AGENT_DEFINE) */ \
	extern bool _proxy##_shadow_validator(const void *msg, size_t msg_size);                   \
