...
:c:macro:`ZBUS_CHAN_DEFINE_WITH_ID`) and shadow channels use :c:macro:`ZBUS_SHADOW_CHANNEL_DEFINE`
...
.. code-block:: c
    ...
    ZBUS_PROXY_ADD_CHANNEL(PROXY_NODE, my_channel);
...
.. code-block:: c
    ...
    ZBUS_SHADOW_CHANNEL_DEFINE(my_channel,              /* Name (must match remote channel name) */
                               struct my_msg,           /* Message type */
